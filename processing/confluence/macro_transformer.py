...
IGNORED_MACROS = {
    ...
    "drawio-sketch",
    "inc-drawio",
    "glossary-search-name",
    "contributors",
    "ISSUES_REPORTED_LIST",
    "TEST_RESULTS_OVERALL_PROGRES",
    "TEST_CASES_CREATED_OVER_TIME",
    "TEST_CASES_SUMMARY_BY_STATUS",
    "TEST_CASES_BY_PROJECT_LIST",
    "TEST_CASES_BY_FOLDER_LIST",
    "TEST_CASES_BY_COMPONENT_LIST",
    "TEST_RESULTS_ADVANCED",
    "TEST_RESULTS_OVERALL_PROGRES",
    "TEST_RESULTS_SUMMARY_BY_COMPONENT",
    "TEST_RESULTS_SUMMARY_BY_LABEL",
    "TEST_RESULTS_SUMMARY_BY_STATUS",
    "TEST_RESULTS_SUMMARY_BY_TEST_RUN",
    "linkgraph",
    "leanix-widget",
    "listlabels",
    "viewxls"
